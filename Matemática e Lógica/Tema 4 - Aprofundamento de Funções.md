...
Conteúdo interativo<br>Acesse a versão digital para ver mais detalhes da imagem<br>abaixo.<br>Função de x em y.<br><!-- End of picture text -->
...
<!-- Start of picture text -->
A alternativa A está correta.<br><!-- End of picture text -->
...
<!-- Start of picture text -->
A O domínio é   ea imagem vai de 0 a 1.<br>B<br>O domínio é   e a imagem vai de -1 a 1.<br>C<br>O domínio é   e a imagem vai de 0 a 1.<br>D<br>O domínio é   e a imagem vai de -1 a 1.<br><!-- End of picture text -->
...
<!-- Start of picture text -->
Conteúdo interativo<br>Acesse a versão digital para ver mais detalhes da imagem<br>abaixo.<br>Gráfico: função \(f(x) = 3x + 2\)<br><!-- End of picture text -->
...
<!-- Start of picture text -->
Gráfico: Função afim \(f(x) = 3x - 5\).<br><!-- End of picture text -->
...
<!-- Start of picture text -->
Representação de uma função bijetora.<br><!-- End of picture text -->
...
<!-- Start of picture text -->
Se  , qual o valor de   ?<br>A 1<br>B 2<br>C 3<br>D 4<br>E 5<br>A alternativa C está correta.<br>Note que:<br>Logo, temos:<br><!-- End of picture text -->
...
|x|0|1|2|3|4|5|
|---|---|---|---|---|---|---|
|f(x)|(−1)<sup>0</sup>= 1|(−1)<sup>1</sup>= −1|(−1)<sup>2</sup>= 1|(−1)<sup>3</sup>= −1|(−1)<sup>4</sup>= 1|(−1)<sup>5</sup>= −1|
...
|C|a função h(x) = ƒ(<sup>x</sup>/2) é periódica de período 1.|
|D|a função h(x) = ƒ(x + q), sendo q uma constante positiva, não é periódica.|
|E|a função h(x) = ƒ(<sup>x</sup>/2) não é periódica.|
|A alt<br>Note<br>g(x +<br>A fun|ernativa B está correta.<br>que a função g(x) = ƒ(2x) é periódica de período 1, pois:<br>1) = ƒ(2(x + 1)) = ƒ(2x + 2) = ƒ(2x) = g(x)<br>ção h(x) = ƒ(<sup>x</sup>/2) é periódica de período 4.|
